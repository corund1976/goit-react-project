...
const getPeriodData = (date) =>
  axios.get(`/transaction/period-data?date=${date}`); //date=YYYY-MM
/* User */
const updateUserBalance = (balance) =>
  axios.patch("/user/balance", balance); //balance={newBalance: balance}
const getUserInfo = () =>
  axios.get("/user");

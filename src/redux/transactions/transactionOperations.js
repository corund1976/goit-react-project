...
const handleDeleteIncome = transactionId => dispatch => {
  ...
  api
    ...
    .then(({ data }) => dispatch(transactionActions.deleteIncomeSuccess({ data, transactionId })))
    .catch(error => dispatch(transactionActions.deleteIncomeError(error.message)));
};
...
const handleDeleteExpense = transactionId => dispatch => {
  ...
  api
    .deleteTransaction(transactionId)
    .then(({ data }) => dispatch(transactionActions.deleteExpenseSuccess({ data, transactionId })))
    .catch(error => dispatch(transactionActions.deleteExpenseError(error.message)));
};
